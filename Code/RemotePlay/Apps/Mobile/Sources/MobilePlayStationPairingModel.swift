...
enum MobilePlayStationPairingStatus: Equatable {
    case editing
...
@MainActor
@Observable
final class MobilePlayStationPairingModel {
    ...
    private(set) var status: MobilePlayStationPairingStatus = .editing
    ...
    var advancedAccountEntryIsExpanded = false
    var manualAccountID = ""
    ...
    func applyManualAccountID() {
        do {
            ...
            advancedAccountEntryIsExpanded = false
            errorMessage = nil
        } catch {
            accountIdentity = nil
    ...
    private func beginOperation(status: MobilePlayStationPairingStatus) -> UUID {
        let requestID = UUID()
    ...
    private func finishOperation(
        _ requestID: UUID,
        status: MobilePlayStationPairingStatus
    ) {
