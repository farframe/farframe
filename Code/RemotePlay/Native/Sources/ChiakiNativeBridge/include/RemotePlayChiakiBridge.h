...
#define RP_CHIAKI_NATIVE_ABI_VERSION 8u
...
typedef enum RPChiakiSessionEventType {
    ...
    RP_CHIAKI_SESSION_EVENT_LOGIN_REQUIRED = 3,
    /* Only the fixed numeric stage below, never native log text. */
    RP_CHIAKI_SESSION_EVENT_CONNECTION_STAGE = 4,
} RPChiakiSessionEventType;

/* Stable, credential-free startup breadcrumbs from the pinned runtime. */
typedef enum RPChiakiConnectionStage {
    RP_CHIAKI_CONNECTION_REQUESTING_SESSION = 1,
    RP_CHIAKI_CONNECTION_REQUEST_SENT = 2,
    RP_CHIAKI_CONNECTION_SESSION_ACCEPTED = 3,
    RP_CHIAKI_CONNECTION_STARTING_CONTROL = 4,
    RP_CHIAKI_CONNECTION_MEASURING_NETWORK = 5,
    RP_CHIAKI_CONNECTION_NETWORK_CHECKED = 6,
    RP_CHIAKI_CONNECTION_STREAM_HANDSHAKE = 7,
    RP_CHIAKI_CONNECTION_STREAM_ACCEPTED = 8,
    RP_CHIAKI_CONNECTION_STREAM_INFO = 9,
    RP_CHIAKI_CONNECTION_REQUEST_CONNECT_FAILED = 101,
    RP_CHIAKI_CONNECTION_REQUEST_SEND_FAILED = 102,
    RP_CHIAKI_CONNECTION_RESPONSE_MISSING = 103,
    RP_CHIAKI_CONNECTION_RESPONSE_INVALID = 104,
    RP_CHIAKI_CONNECTION_NONCE_INVALID = 105,
    RP_CHIAKI_CONNECTION_STREAM_REPLY_MISSING = 106,
} RPChiakiConnectionStage;
